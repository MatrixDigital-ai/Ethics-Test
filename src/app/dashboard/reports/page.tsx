...
export default function ReportsPage() {
    ...
    const handleDownloadPDF = async (report: typeof DEMO_REPORTS[0]) => {
        ...
        setTimeout(async () => {
            ...
            pdf.save(`EthicsIQ_Report_${report.employeeName.replace(/\s/g, '_')}.pdf`);
        }, 500);
    };
                ...
                {selectedReport && (
                    <div>
                        <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 8 }}>
                            ...
                            <div>
                                <div style={{ fontSize: 24, fontWeight: 800, color: '#0F172A' }}>EthicsIQ Report</div>
                                <div style={{ fontSize: 12, color: '#94A3B8' }}>Employee Ethics Assessment</div>
                            </div>
                        </div>
                        ...
                        <div style={{ marginTop: 24, textAlign: 'center', fontSize: 11, color: '#94A3B8' }}>
                            Generated by EthicsIQ — AI-Powered Ethics Assessment Platform
                        </div>
                    </div>
                )}
            </div>
